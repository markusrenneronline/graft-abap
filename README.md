> **Graft-ABAP (ABAP-Pilot auf Basis von Graft 0.18.0).** Einstieg und Installation: [INSTALL-ABAP.md](INSTALL-ABAP.md), Skill für Claude Code: `skill/graft-abap/`. Der folgende Text ist die unveränderte Beschreibung des Ausgangsprojekts.
